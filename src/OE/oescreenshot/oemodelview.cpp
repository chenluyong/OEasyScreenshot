...
OEModelView::OEModelView(MODEL model,
    ...
    case MODEL::Rectangle:
        drawFunc_ = &OEModelView::drawRect;
        break;
    case MODEL::Roundness:
        drawFunc_ = &OEModelView::drawEllipse;
        break;
    default:
    {
        drawFunc_ = &OEModelView::drawArrows;
...
void OEModelView::drawRect(const QPoint &startPoint, const QPoint &endPoint,
                           QPainter &paiter) {
    paiter.setPen(color_);
    paiter.drawRect(QRect(startPoint, endPoint));
}

void OEModelView::drawEllipse(const QPoint &startPoint, const QPoint &endPoint,
                              QPainter &paiter) {
    paiter.setPen(color_);
    paiter.drawEllipse(QRect(startPoint, endPoint));
}
